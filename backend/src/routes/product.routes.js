...
productRouters.delete('/api/product/:id', productController.deleteProduct)
productRouters.delete('/api/product/desable/:name', productController.desableProduct)
productRouters.put('/api/product/enable/:name', productController.enableProduct)
